...
(defun vimgolf-right-solution ()
  ...
  (let ((keystrokes-count (vimgolf-count-keystrokes)))
    (message "Hurray! You solved %s in %d keystrokes!" vimgolf-challenge keystrokes-count)
    (vimgolf-save-results vimgolf-challenge keystorkes-count vimgolf-keystrokes)))

(defun vimgolf-save-results (id cnt keystrokes)
  (setf (cdr (rassoc id vimgolf-scores)) (:cnt cnt :keys keystrokes)))
